...
def main(win, width):
	...
	while run:
        ...
        # if started:
        # continue
        # press continue , right and left click mouse control, delete and draw control
        # [0] left mouse btn
			if pygame.mouse.get_pressed()[0]:
				pos = pygame.mouse.get_pos()
				row, col = get_clicked_pos(pos, ROWS, width)
				spot = grid[row][col]
                # make sure the start point != end point
            ...
            # algoritm -> event
            # spacebar for update and start after 
            # use lambda fnc for anonymous func , it is like a def func but without name
